(function () {
  const translations = {
    en: {
      ...
      "sender.multiTitle": "Multiple recipients",
      "sender.multiHelp": "Optional · up to 5 devices per link",
      ...
      "status.remaining": "Session expires in",
      "status.verifyPrompt": "Compare the code shown on the receiving device",
      "status.approve": "Codes match — allow connection",
      "multi.label": "Receiving devices",
      "multi.title": "Multiple recipients",
      "multi.waiting": "Waiting for a receiving device to open the link",
      "multi.bandwidth": "Each device receives a separate transfer. More recipients use more upload bandwidth.",
      "multi.stopAll": "Stop all",
      "multi.stopAllConfirm": "Stop all receiving devices? Incomplete files will be discarded and the pickup entry will expire.",
      "multi.device": "Receiving device {number}",
      "multi.opened": "Waiting for confirmation",
      "multi.confirmed": "Confirmed",
      "multi.verification": "Waiting for code check",
      "multi.connecting": "Connecting",
      "multi.connected": "Waiting for acceptance",
      "multi.transferring": "Transferring",
      "multi.received": "Received",
      "multi.complete": "Complete",
      "multi.stopped": "Stopped",
      "multi.error": "Connection failed",
      "multi.code": "Code {code}",
      "multi.approve": "Allow connection",
      ...
      "transfer.keepOpen": "Do not close this window during transfer",
      "transfer.stop": "Stop transfer",
      "transfer.stopConfirm": "Stop this transfer? The other device will be notified and incomplete files will be discarded.",
      "transfer.stoppedKicker": "Transfer stopped",
      "transfer.stoppedByYou": "You stopped the transfer",
      "transfer.stoppedByPeer": "The other device stopped the transfer",
      "transfer.stoppedDetail": "Incomplete files were discarded.",
      ...
      "error.channelClosed": "The connection closed during transfer.",
      "error.chunkSize": "The negotiated transfer chunk size is invalid.",
      "connection.lan": "Local network · direct",
      "connection.direct": "Internet · direct",
      "connection.relay": "Internet · relay",
      "sender.transferring": "Encrypting and transferring",
      "sender.transferDetail": "{count} file(s) · {size} · keep this page open",
      "sender.transferLive": "{count} file(s) · {size} · {speed} · keep this page open",
      ...
      "error.roomFull": "The recipient limit has been reached. Contact the sender.",
      ...
      "pickup.full": "The recipient limit has been reached. Contact the sender.",
