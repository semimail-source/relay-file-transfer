(function () {
  const translations = {
    en: {
      ...
      "nav.pickup": "Enter pickup code",
      "home.eyebrow": "Direct browser file transfer",
      "home.title": "Pass big files,<br><em>gently and directly.</em>",
      "home.lede": "Choose files on any device and open a link on another. Files move directly between the two browsers—without email or cloud storage.",
      ...
      "sender.stepSelect": "01 / Choose files",
      "sender.devices": "Any device → any device",
      "sender.drop": "Drop files here, or click to choose several",
      ...
      "share.eyebrow": "Waiting for the receiving device",
      "share.title": "Send the link<br><em>to the recipient.</em>",
      ...
      "share.stepOpen": "02 / Open the link",
      ...
      "receiver.initialTitle": "One moment,<br><em>securely pairing.</em>",
      ...
      "pickup.eyebrow": "Permanent pickup page",
      "pickup.title": "Enter a pickup code<br><em>and collect your files.</em>",
      ...
      "receiver.incomingTitle": "Files are waiting.<br><em>Receive them?</em>",
      ...
      "receiver.receivingTitle": "Files are moving<br><em>across the network.</em>",
      ...
      "receiver.saveTitle": "Files arrived.<br><em>Save them one by one.</em>",
      ...
      "receiver.confirmTitle": "Confirm receipt,<br><em>then start the timer.</em>",
      ...
      "receiver.codeTitle": "One more check,<br><em>then receive.</em>",
      ...
      "receiver.pairTitle": "Confirmed.<br><em>Securely pairing.</em>",
